...
namespace PixelCrew.Components
{
    public class ProbabillityDropComponent : MonoBehaviour
    {
        ...
        public void CalculateDrop()
        {
            ...
            var itemCount = 0;
            var total = _drop.Sum(dropData => dropData.Probabillity);
            var sortedDrop = _drop.OrderBy(dropData => dropData.Probabillity);
        ...
        public class DropData
        {
            ...
            [Range(0f, 100f)] public float Probabillity;
        }
    }
